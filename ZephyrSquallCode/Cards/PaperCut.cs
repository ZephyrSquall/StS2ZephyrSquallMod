...
public class PaperCut() : ZephyrSquallCard(1, CardType.Power, CardRarity.Uncommon, TargetType.Self)
{
    protected override IEnumerable<DynamicVar> CanonicalVars => [new PowerVar<PaperCutPower>(7), new CardsVar(2)];
    ...
    {
        await PowerCmd.Apply<PaperCutPower>(choiceContext, Owner.Creature, DynamicVars["PaperCutPower"].IntValue,
            Owner.Creature, this);
