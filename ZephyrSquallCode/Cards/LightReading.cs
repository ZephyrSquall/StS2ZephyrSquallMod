...
public class LightReading() : ZephyrSquallCard(1,
    ...
    TargetType.Self)
{
    ...
    protected override async Task OnPlay(
        ...
        CardPlay play)
    {
        await PowerCmd.Apply<LightReadingPower>(choiceContext, Owner.Creature, DynamicVars["LightReadingPower"].IntValue, Owner.Creature, this);
    }
